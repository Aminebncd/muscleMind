...
#[ApiResource(
    ...
    normalizationContext: ['groups' => ['muscle_group:read']],
    denormalizationContext: ['groups' => ['muscle_group:write']]
)]
class MuscleGroup
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    #[Groups(['muscle_group:read'])]
    private ?int $id = null;

    #[ORM\Column(length: 255)]
    #[Groups(['muscle_group:read', 'muscle_group:write', 'muscle:read', 'exercice:read'])]
    ...
    #[Groups(['muscle_group:read', 'muscle_group:write'])]
