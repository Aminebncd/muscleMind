...
INSERT INTO `performance` (`id`, `user_performing_id`, `exercice_mesured_id`, `personnal_record`, `date_of_performance`) VALUES
	...
	(8, 1, 191, '130', '2024-06-12 11:51:58');
...
INSERT INTO `tracking` (`id`, `user_tracked_id`, `height`, `weight`, `date_of_tracking`) VALUES
	...
	(4, 1, '186', '92', '2024-06-12 06:36:34'),
	(5, 1, '186', '85', '2024-06-12 06:36:56'),
	(6, 1, '186', '80', '2024-06-12 06:37:09'),
	(7, 1, '186', '92', '2024-06-12 11:51:10');
...
INSERT INTO `user` (`id`, `username`, `email`, `date_of_birth`, `sex`, `roles`, `password`, `score`, `is_verified`) VALUES
	(1, 'aminebncd', 'aminebncd_pro@hotmail.com', '2001-01-15 00:00:00', 'male', '{"0": "ROLE_ADMIN", "2": "ROLE_MODERATOR"}', '$2y$13$9w0wbfZqweUoXdaPcqRHqu4nDNyeSHbWHpL7OHS0yDaNTvdAW8an2', 0, 1);
