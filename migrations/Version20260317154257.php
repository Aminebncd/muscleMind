 ...
 */
final class Version20260317154257 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE tracking (id INT AUTO_INCREMENT NOT NULL, user_tracked_id INT NOT NULL, height VARCHAR(3) DEFAULT NULL, weight VARCHAR(3) DEFAULT NULL, date_of_tracking DATETIME NOT NULL, INDEX IDX_A87C621CDDA0EDA4 (user_tracked_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE `user` (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(30) NOT NULL, email VARCHAR(180) NOT NULL, date_of_birth DATETIME DEFAULT NULL, sex VARCHAR(20) DEFAULT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, score INT NOT NULL, is_verified TINYINT(1) NOT NULL, last_reset_year INT NOT NULL, UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user_ressource (user_id INT NOT NULL, ressource_id INT NOT NULL, INDEX IDX_937FC8A0A76ED395 (user_id), INDEX IDX_937FC8A0FC6CD52A (ressource_id), PRIMARY KEY(user_id, ressource_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE workout_plan (id INT AUTO_INCREMENT NOT NULL, exercice_id INT NOT NULL, program_id INT DEFAULT NULL, number_of_repetitions INT NOT NULL, weights_used INT NOT NULL, intensification_method VARCHAR(20) DEFAULT NULL, INDEX IDX_A5D4580189D40298 (exercice_id), INDEX IDX_A5D458013EB8070A (program_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
