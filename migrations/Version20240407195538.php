 ...
 */
final class Version20240407195538 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_D044D5D461220EA6 ON session (creator_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_D044D5D461220EA6 ON session');
