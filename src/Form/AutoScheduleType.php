    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ->add('daysOfWeek', ChoiceType::class, [
                ...
                'expanded' => false,
                'attr' => [
                    'class' => 'flex flex-col w-full text-white dark:bg-primary/80 border border-primary px-4 py-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-600 mb-8',
                ],
                'row_attr' => [
